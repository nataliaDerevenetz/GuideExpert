...
@Database(entities = [ExcursionEntity::class, RemoteKeyEntity::class, ExcursionFilterEntity::class,
                     ImageEntity::class, ExcursionDataEntity::class], version = 1,exportSchema = false)
